...
//               Свяжитесь с нами, чтобы заказать шторы под индивидуальный заказ
//             </h2>
//             <Button
...
//                 Мы на связи по будням с 8:00 до 21:00
//               </p>
//             </div>
...
//       <ModalCall isOpen={isModalOpen} onClose={handleCloseModal} />
//     </>
//   );
// };
