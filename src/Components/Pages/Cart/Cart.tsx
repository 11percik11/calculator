    ...
    <div className="cart">
      ...
      <div className="cart__container">
        ...
        <StarAnimation/>
                  ...
                  <p className='cart__title-text'>Оформите заказ сейчас и мы доставим его за 5 дней.</p>
            ...
            cartItems.map((item) => (
              <div key={item.id} className="cart__item">
                ...
                <div className="cart__item-info">
                  ...
                  <p className="cart__item-price">{item.price.toLocaleString('ru-RU')} PУБ</p>
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="cart__form-phone">
                <h3 className="cart__form-phone-text">ВВЕДИТЕ НОМЕР ТЕЛЕФОНА</h3>
                <div className="phone-input-container">
                <input
                    type="tel"
                    className={`cart__form-phone-input ${phoneError ? 'input-error' : ''}`}
                    name="phone"
              ...
              <Button
                ...
                disabled={loading || !!phoneError || formData.phone.length !== 11 || cartItems.length === 0}
              />

              <div className="cart__form-footer">
                <p className="cart__form-privacy">
                  Нажимая кнопку "Оформить заказ", вы соглашаетесь с{' '}
                  <span className="cart__form-link" onClick={handlePrivacyPolicyClick}>
                    Политикой конфиденциальности
                  </span>{' '}
                  и{' '}
                  <span className="cart__form-link" onClick={handleDataPolicyClick}>
